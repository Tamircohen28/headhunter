...
> "Run `/headhunter:setup` first — the application assistant needs your profile and CV text to tailor anything meaningful."
...
> Proceed with tailoring? Or run `/headhunter:scan` first to understand the gaps."
...
- [ ] Run `/headhunter:brief <company>` if you haven't done full company research
- [ ] Add a task: "Follow up in 7 days" → `/headhunter:add-task`
