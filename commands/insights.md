...
- "Add prep tasks for these topics?" → use `/headhunter:add-task`
- "Update prep notes on the scheduled round?" → use `crud.js update interviews <id>`
- "Run the full research pipeline?" → suggest `/headhunter:research`
