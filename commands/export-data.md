...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/export-applications.js --format csv  --out ./headhunter-export.csv
node ${CLAUDE_PLUGIN_ROOT}/scripts/export-applications.js --format json --out ./headhunter-export.json
```
