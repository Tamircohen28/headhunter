...
→ Apply CV changes: run /jobtrack:apply to generate a tailored version for a specific role
→ Review again after changes: re-run /jobtrack:cv-review
```
