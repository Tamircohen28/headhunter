...
description: Developer mode — scaffold or regenerate the JobTrack Base44 React web app (Vite + React + Tailwind + shadcn/ui + Base44 SDK) and its entities/functions. Triggers on build jobtrack app, base44, scaffold react app, regenerate entities.
allowed-tools: Read, Write, Edit, Bash, Grep, Glob
---

# Scaffold Base44 App (developer mode)

Reproduce the JobTrack web app from the documented data model and server
