---
name: jobtrack:settings
description: View or update JobTrack settings — default currency, study weeks, hours per week, stale threshold, and data directory. Triggers on settings, configure jobtrack, change currency, set stale threshold, update config.
