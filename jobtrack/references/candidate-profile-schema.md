...
Used by: `/jobtrack:brief` (personalization), `/jobtrack:search` (job filtering),
...
| `salary.floor_ils` | Hard minimum. `/jobtrack:brief` flags roles whose band appears below this. |
